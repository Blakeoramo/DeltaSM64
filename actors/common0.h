...
extern const Gfx exclamation_box_seg8_dl_purple[];
#endif
...
extern const GeoLayout red_koopa_shell_geo[];
// extern const GeoLayout koopa_shell2_geo[];
// extern const GeoLayout koopa_shell3_geo[];
extern const Gfx koopa_shell_seg8_dl_red_koopa_shell[];
...
extern const Gfx koopa_shell_seg8_dl_red_shell_dl[];
